					...
					<div class="col-xs-12">
						<form method="post">
							<div class="input-group">
								<select class="form-control" name="order_by_var" id="order_by_var">
									<option value="" disabled selected hidden>Order by...</option>
									<option value="derby_name">Derby Name</option>
									<option value="activity.date">Date of Activity</option>
